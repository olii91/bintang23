    ...
    <div class="row justify-content-between">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 col">
            <div class="content content-bottom shadow">
                <div>
                    <img src="{{ asset('images/miku.jpg') }}" alt="user profile" class="photo">
                    <div class="self-align">
                        <h5><a href="#" syle="color: #6a70fc">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            <div class="laporan-top">
                <img src="{{ asset('images/miku.jpg') }}" alt="profile" class="profile">
